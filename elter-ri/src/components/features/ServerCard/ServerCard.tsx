...
export const EmptyServerCard: React.FC<EmptyServerCardProps> = ({
  ...
  return (
    <Card
      className={cn(
        "min-h-[190px] group w-full flex items-center justify-center border-2 border-dashed border-secondary bg-transparent transition-all duration-200 dark:border-primary/30 py-4",
    ...
    >
      <CardContent className="flex flex-col items-center justify-center w-full h-full text-center">
        <SquarePlus
          className="w-16 h-16 text-border group-hover:text-primary/80 transition-colors duration-200 text-secondary dark:text-base-500"
          strokeWidth={2}
        />
      </CardContent>
    </Card>
